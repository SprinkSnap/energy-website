/**
 * Headless responsiveness check for Base Loads Water Usage section.
 */
  ...
  for (const width of WIDTHS) {
    ...
    const metrics = await page.evaluate(() => {
      const labelsRequired = [
        "Temperature",
        "Faucet flow rate",
        "Faucet use per occupant per day",
        "Shower head flow rate",
        "Average shower duration",
        "Number of showers per occupant per week",
        "Installed",
        "Rated values",
        "Rated water consumption per cycle",
