...
const renderGenerationMainScreen = extractFunction("renderGenerationMainScreen");
const renderGenerationPvScreen = extractFunction("renderGenerationPvScreen");
...
const systemsFieldMarkers = [
  ...
  },
  {
    ...
    markers: [
      ...
      "bindGenerationMainScreen",
      "clampGenerationPvCount",
    ],
  },
  {
    tab: "Generation — Photovoltaic System",
    fn: renderGenerationPvScreen,
    markers: [
      "generation-pv",
      "generationSinglePvSystemHTML",
      "bindGenerationPvSystemScreen",
    ],
  },
  {
  ...
  },
  {
    ...
    markers: [
      ...
      "mountVentilationWholeHouseComponentsSection",
      "ventilationSupplementalComponentsSectionHTML",
      "ventilationSupplementalComponentsHTML",
      "mountVentilationSupplementalComponentsSection",
  ...
  },
  {
    ...
    markers: [
      ...
      "heatingCoolingSystemSeasonSectionHTML",
      "heatingCoolingSystemFansPumpsSectionHTML",
      "heatingCoolingSystemSeasonFansPumpsTabSectionHTML",
      "mountHeatingCoolingSystemSeasonSection",
      "mountHeatingCoolingSystemFansPumpsSection",
      "heatingSeasonTabHTML",
      "heatingFansPumpsTabHTML",
      "heatingSeasonFansPumpsTabHTML",
      "heatingCoolingSystemBaseboardsSectionHTML",
      "mountHeatingCoolingSystemBaseboardsSection",
  ...
  },
  {
    ...
    markers: [
      ...
      "hotWaterSecondaryFieldsHTML",
      "domesticHotWaterSecondarySectionHTML",
      "mountDomesticHotWaterSecondarySection",
      "bindHotWaterDhw",
...
assert(renderAllForms.includes("renderGenerationMainScreen"), "renderAllForms must call renderGenerationMainScreen");
assert(renderAllForms.includes("renderGenerationPvScreen"), "renderAllForms must call renderGenerationPvScreen");
