...
async function run() {
  ...
  await page.waitForSelector("#screen-systems-base-loads-electrical .base-loads-electrical-section", { timeout: 90000 });
  ...
  for (const width of WIDTHS) {
    ...
    const metrics = await page.evaluate(() => {
      ...
      const section = document.querySelector("#screen-systems-base-loads-electrical .base-loads-electrical-section");
      ...
      const localItems = [...(document.querySelectorAll(".base-loads-local-nav-item") || [])].filter(isVisible);
      return {
        overflow,
        clippedLabels,
        clippedInputs,
